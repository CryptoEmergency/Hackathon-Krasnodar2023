    ...
    return (
        <div class="admin__univer">
            <div class="admin__container">
                <h2 style="margin-bottom:15px">Административная панель</h2>
                <div  class="input_login" id="auth-label1">
                    ...
                    {
                        this.Static.faculty.map((item,index)=>{
                            return(
                                <div class="speciality__conteiner">
                                    <img class="delete_icon" src={iconDelete}
                                        onclick={()=>{
                                            this.Static.faculty.splice(index, 1)
                                            this.init()
                                        }}
                                        >                        
                                    </img>    
                                    ...
                                    <div  class="input_login" id="auth-label4">
